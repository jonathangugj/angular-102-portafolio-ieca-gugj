...
function vaciarCarritoConTotal() {
    ...
    let tamCarrito = carrito.length;
    for (let index = 0; index < tamCarrito; index++) {
        articulo = carrito.shift();
...
function cuentaDeAlumnos() {
    ...
    const grupoC=grupoA.concat(grupoB);
    console.log(grupoC.length);
}
...
function transmitiendoBatch() {
    ...
    const backA = backup.slice(0, 50);
    const backB = backup.slice(50, 100);
    const backC = backup.slice(100, 150);
    const backD = backup.slice(150, 299);
    console.log(`[${backA}] ${backA.length}`);
    console.log();
    console.log(`[${backB}] ${backB.length}`);
    console.log();
    console.log(`[${backC}] ${backC.length}`);
    console.log();
    console.log(`[${backD}] ${backD.length}`);
}
